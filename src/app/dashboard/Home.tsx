        ...
        <div className={classes.H100center + " animate__animated animate__fadeInUp"}>
            <div className={"container-fluid py-4  "}>
                ...
                <div className="row mt-4">
                    ...
                    <div className="col-lg-8 col-md-12 mb-md-0 mb-4">
                        <div className="card">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div className="d-flex px-2 py-1">
                                                        <div>
                                                            <img src="/Dashboard/img/small-logos/logo-xd.svg" className="avatar avatar-sm me-3" alt="xd" />
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="d-flex px-2 py-1">
                                                        <div>
                                                            <img src="/Dashboard/img/small-logos/logo-atlassian.svg" className="avatar avatar-sm me-3" alt="atlassian" />
                                                        </div>
                                                        <div className="d-flex flex-column justify-content-center">
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="d-flex px-2 py-1">
                                                        <div>
                                                            <img src="/Dashboard/img/small-logos/logo-slack.svg" className="avatar avatar-sm me-3" alt="team7" />
                                                        </div>
                                                        <div className="d-flex flex-column justify-content-center">
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="d-flex px-2 py-1">
                                                        <div>
                                                            <img src="/Dashboard/img/small-logos/logo-spotify.svg" className="avatar avatar-sm me-3" alt="spotify" />
                                                        </div>
                                                        <div className="d-flex flex-column justify-content-center">
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="d-flex px-2 py-1">
                                                        <div>
                                                            <img src="/Dashboard/img/small-logos/logo-jira.svg" className="avatar avatar-sm me-3" alt="jira" />
                                                        </div>
                                                        <div className="d-flex flex-column justify-content-center">
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="d-flex px-2 py-1">
                                                        <div>
                                                            <img src="/Dashboard/img/small-logos/logo-invision.svg" className="avatar avatar-sm me-3" alt="invision" />
                                                        </div>
                                                        <div className="d-flex flex-column justify-content-center">
