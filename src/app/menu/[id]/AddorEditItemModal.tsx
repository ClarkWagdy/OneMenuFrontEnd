        ...
        <Formik
          ...
          onSubmit={(values, actions) => {
            ...
            if (props.product) {
              ...
              axios.post(`${url}/product/edit`, valuesData, {
                headers: {
              ...
              axios.post(`${url}/product/create`, valuesData, {
                headers: {
                  'Authorization': User.token
                }
              }).then(res => {
          ...
          {({ errors, touched, values, setFieldValue, isValid }) => (
            <Form className={classes.AddItemForm}>
              ...
              <div className='my-1 w-100'>
                ...
                <div className={classes.Inputsflexcenter}>
                  <div className='d-flex flex-column w-100'>
                    <Field name='descAR' as='textarea' className={classes.AddInput} placeholder={strings.NameofthenewIteminArabic} style={errors.descAR && touched.descAR ? { borderColor: "tomato" } : {}} />
                  ...
                  <div className='d-flex flex-column w-100'>
                    <Field name='descEN' as='textarea' className={classes.AddInput} placeholder={strings.NameofthenewIteminEnglish} style={errors.descEN && touched.descEN ? { borderColor: "tomato" } : {}} />
