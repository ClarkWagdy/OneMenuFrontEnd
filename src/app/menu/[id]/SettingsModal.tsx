...
const SettingsModal: FC<Props> = (props: Props) => {
  ...
  const [ChangeLan, setChangeLan] = useState<boolean>(
    Restaurant.changeLanguageStatus,
  );

  const [Offers, setOffers] = useState<boolean>(
    Restaurant.offerStatus ? Restaurant.offerStatus : false,
  );
  const [Video, setVideo] = useState<boolean>(
    Restaurant.videoStatus ? Restaurant.videoStatus : false,
  );
  const [defaultLanguage, setdefaultLanguage] = useState<number>(
    Restaurant.defaultLanguage ? Restaurant.defaultLanguage : 1,
  );

  const [Images, setImages] = useState<any>(
    Restaurant.offers && Restaurant.offers.length > 0 ? Restaurant.offers : [],
  );
...
console.log("Restaurant data in SettingsModal:", Restaurant);
  // NOTE: confirm the actual field name on RestaurantT / RestaurantDTO.
  // Using Restaurant.orderEnabled here — update if your type uses a different key
  // (e.g. allowOrders, orderingEnabled).
  const [OrderEnabled, setOrderEnabled] = useState<boolean>(
  ...
  function HandleSave() {
    ...
    formData.append("orderEnabled", OrderEnabled);
      ...
      <Modal.Body>
        ...
        <div className="mb-4">
          <div className="d-flex align-items-center">
            ...
            <h5 className="p-0 m-0 mx-2 fw-bold">{strings.LanguageSettings}</h5>
          </div>

          <div className="w-100 d-flex justify-content-between align-items-center px-3 mt-2">
            <label htmlFor="allowChangeLan" className="fw-bold color-gray">
              {strings.Allowuserstochangethelanguage}
            </label>
            <Switch
              onChange={(e) => {
                setChangeLan(e);
          ...
          <div className="w-100 d-flex justify-content-between align-items-center px-3 mt-2">
            <label className="fw-bold color-gray">
        ...
        <div className="mb-4">
          <div className="d-flex align-items-center">
            ...
            >
              <g>
                <path
                  d="M493.807 353.153L353.153 493.807a30.657 30.657 0 0 1-43.351 0L18.194 202.198a30.657 30.657 0 0 1-8.981-21.676V30.667C9.213 18.789 18.789 9.213 30.667 9.213h149.855a30.656 30.656 0 0 1 21.676 8.981l291.609 291.609a30.656 30.656 0 0 1 0 43.35z"
                  fill="none"
                  stroke="#000000"
                  strokeWidth="20"
                ></path>
                <circle cx="98.667" cy="98.667" r="20" fill="#000000"></circle>
              </g>
            </svg>
        ...
        <div>
          <div className="d-flex align-items-center">
            ...
            <h5 className="p-0 m-0 mx-2 fw-bold">{strings.Advertisingmedia}</h5>
          </div>
          ...
          <div className="w-100 d-flex  flex-column px-3 mt-2">
            ...
            <div
              className={
                classes.OffersImag +
                ` px-3 py-2 d-flex flex-wrap ${Images.length > 0 ? "justify-content-center" : ""} `
              }
            >
              {Images.length > 0
                    ...
                    return (
                      ...
                      >
                        ...
                        <img
                          src={
                            image.fileName
                              ? `${OffersImagePath}/${image.fileName}`
          ...
          <div className="w-100 d-flex  flex-column px-3 mt-2">
            <div className="d-flex align-items-center w-100 justify-content-between">
              <div className="d-flex">
                ...
                >
                  <g>
                    <path
                      d="m338.95 243.28-120-75A15.002 15.002 0 0 0 195.999 181v150a15 15 0 0 0 22.95 12.72l120-75a15 15 0 0 0 .001-25.44zM226 303.936v-95.873L302.698 256z"
                      fill="#000000"
                      data-original="#000000"
                    ></path>
                    <path
            ...
            <div
              className={
                classes.OffersImag +
                ` px-3 py-2 d-flex align-items-center ${Images.length > 0 ? "justify-content-center" : ""} `
              }
            >
              {VideoUrl ? (
                <div
                  className={
                    classes.offerImg + "   animate__animated animate__fadeIn "
                  }
                >
        ...
        <div className={classes.dCenter + "   w-100"}>
          <button
            type="submit"
            className={classes.AddBtn + " " + classes.Save_Btn}
            onClick={() => HandleSave()}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
