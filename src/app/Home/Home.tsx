...
export default function HomePage() {
    ...
    return (
      <>
        <Head />
        <div id="HomePage" className="is-boxed has-animations">
                  ...
                  <div className="hero-inner">
                    <div className="hero-copy">
                      <h1 className="hero-title mt-0">
                        Transforming Ideas into Reality with AI-Driven Solutions
                      </h1>
                      <p className="hero-paragraph">
                        At One, we merge cutting-edge software development with
                        the power of AI to deliver innovative solutions tailored
                    ...
                    <div className="features-wrap">
                      <div className="feature text-center is-revealing">
                        <div className="feature-inner">
                          ...
                          <p className="text-sm">
                            At One, we are a team of passionate technologists,
                            developers, and AI experts dedicated to driving your
                            business forward. We specialize in crafting custom
                            software solutions that leverage the latest in
                            artificial intelligence to help you stay ahead of
                            the competition.
                          </p>
                        </div>
                      </div>
                      {/* <div className="feature text-center is-revealing">
                        <div className="feature-inner">
                          ...
                          <p className="text-sm">
                            ...
                            intelligent, scalable, and efficient software
                        ...
                        <div className="testimonial-inner">
                          <div className="testimonial-main">
                            ...
                            <div className="testimonial-body">
                              <h5 className="m-0 p-0">IMenu App</h5>
                              <p className="mb-0">
                                Enhance your dining experience with our
                                state-of-the-art digital menu, featuring NFC and
                                QR Code technology. Simply tap or scan to
                                instantly access our full menu, place orders,
                                and explore exclusive deals—all from your
                                smartphone. Fast, convenient, and contactless,
                                our digital menu makes ordering easier and more
                                enjoyable than ever.
                              </p>
              ...
              <div className="container">
                <div className="site-footer-inner has-top-divider">
                  ...
                  <div className="footer-copyright">
                    &copy; {year} One, all rights reserved
                  </div>
                </div>
              </div>
            </footer>
