import { ServicesList } from '@/config/Services/Services';
      ...
      <section className="testimonials section">
        ...
        <div className="container " style={{ height: "100vh" }}>
          <div className="testimonials-inner section-inner">
            <h2 className="section-title mt-0 text-center">Our Services</h2>
            <div className="testimonials-wrap">
              {ServicesList.map((ele) => (
                <div key={ele.id} className="testimonial text-xs is-revealing">
                  <div className="testimonial-inner">
                    <div className="testimonial-main">
                      ...
                      <div className="testimonial-body">
                        <h5 className="m-0 p-0">{ele.Title}</h5>
                        <p className="mb-0">{ele.description}</p>
                        {ele.Link && (
                          <Link href={ele.Link.Href}>{ele.Link.Title}</Link>
                        )}
                      </div>
                    </div>
